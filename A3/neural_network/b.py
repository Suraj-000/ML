...
def plot(f1_scores_train,f1_scores_test,hidden_sizes):
    ...
    plot_path=os.path.join("plots","F1_score_vs_hidden_units.png")
...
def main():
    ...
    csv_path=os.path.join(output_path,'prediction_a.csv')
    ...
    for i in hidden_sizes:
        print_star()
        a=time.time()
        print(f'Training for hidden units = {i}')
        kwags_hps={
    ...
    plot(avg_f1_scores_train,avg_f1_scores_test,hidden_sizes)
    print_star()
    end_time=time.time()
