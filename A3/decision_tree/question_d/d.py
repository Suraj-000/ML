...
def plot_new(metrics,i):
    ...
    ax.invert_xaxis()
    plt.tight_layout()
    plot_path=os.path.join("../plots",f"Q4_accuracies_vs_nof_nodes_{i}.png")
...
def main():
    ...
    print(f"Q4. Decision tree construction with One hot encoding and Post Pruning using Gini Index.")
    ...
    for i,d in enumerate(max_depths):
        ...
        a=time.time()
        dtree=DecisionTree(max_depth=d,criterion="gini_index")
